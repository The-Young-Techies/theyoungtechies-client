...
export default function Header() {
    return (
        <header className="w-full h-[100vh] flex flex-col md:flex-row justify-center min-[550px]:py-5 md:justify-between md:items-center items-start px-10 xl:px-20 gap-5 bg-[url('/images/header3.jpg')] relative bg-no-repeat bg-left bg-cover">
            <div className="flex flex-col justify-start items-start gap-4 xl:gap-7  text-start z-10 md:w-2xl xl:w-3xl">
                ...
                <div className="flex flex-col md:flex-row justify-start items-start gap-2">
                   <PrimaryButton label="view our services"/>
                    <ContactButton className="flex min-[500px]:hidden md:flex" />
                </div>
            </div>
            <div className="hidden min-[500px]:flex w-[400px] h-[180px] min-[550px]:w-[400px] min-[550px]:h-[200px] md:w-[400px] md:h-[300px] xl:w-[600px] xl:h-[80vh] rounded-xl bg-[url('/images/home-header.jpg')] relative bg-no-repeat bg-left bg-cover">
