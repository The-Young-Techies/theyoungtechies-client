...
export default function GetStarted() {
    ...
    return (
        <section className="w-[87%] relative m-auto max-md:py-5 rounded-xl z-10 flex justify-between items-center px-20 max-lg:h-full h-[150px] bg-[url('/images/blue-bg.jpg')] bg-no-repeat bg-cover bg-center">
