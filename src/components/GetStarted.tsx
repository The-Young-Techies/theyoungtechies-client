export default function GetStarted() {
    ...
    return (
        <section className=" relative m-auto max-lg:py-5 mx-16 rounded-xl z-10 gap-4 px-5 md:px-10 flex flex-col md:flex-row justify-center text-center md:text-start md:justify-between items-center max-lg:h-full h-[150px] bg-[url('/images/blue-bg.jpg')] bg-no-repeat bg-cover bg-center">
