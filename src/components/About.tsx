            ...
            <div className="flex flex-col md:flex-row justify-center items-center">
                <div className="flex flex-col md:flex-row justify-start md:justify-between items-center gap-3 md:gap-10">
                    <div className="flex flex-col justify-center items-center text-center md:justify-start md:items-start md:text-start">
                        ...
                        <h2 className="text-h6 md:text-h5 xl:text-h4 font-bold capitalize">Helping brands grow with design, tech, and marketing that works.</h2>
                        <button className="text-white hidden md:flex text-base mt-5 border border-blue-600 bg-blue-600 py-2 px-6 rounded-xl capitalize">get started</button>
                    </div>
                ...
                <button className="text-white w-fit flex md:hidden text-base mt-5 border border-blue-600 bg-blue-600 py-2 px-6 rounded-xl capitalize">get started</button>

            </div>
            <div className="md:h-[400px] flex flex-col md:flex-row justify-center gap-6">
