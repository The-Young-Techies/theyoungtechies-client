...
export default function PrimaryButton({
  ...
  return (
    <button
      className={`relative overflow-hidden text-body-small md:text-body font-semibold py-3 px-6 rounded-lg transition-all capitalize duration-200 ${bgColor} ${hoverColor} ${textColor} ${className}`}
